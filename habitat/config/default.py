...
SIMULATOR_SENSOR.POSITION = [0, 0, 0]
...
CAMERA_SIM_SENSOR.HFOV = 79  # horizontal field of view in degrees
...
SIMULATOR_DEPTH_SENSOR.MAX_DEPTH = 20.0
SIMULATOR_DEPTH_SENSOR.NORMALIZE_DEPTH = False
...
### ADDED
_C.SIMULATOR.RGB_SENSOR_RESIZED = CAMERA_SIM_SENSOR.clone()
_C.SIMULATOR.RGB_SENSOR_RESIZED.TYPE = "HabitatSimRGBSensor"
_C.SIMULATOR.RGB_SENSOR_RESIZED.UUID = "rgb_resized"
_C.SIMULATOR.RGB_SENSOR_RESIZED.HEIGHT = 640
_C.SIMULATOR.RGB_SENSOR_RESIZED.WIDTH = 480
_C.SIMULATOR.RGB_SENSOR_RESIZED.HFOV = 79
_C.SIMULATOR.RGB_SENSOR_RESIZED.POSITION = [0.0, 1.0, 0.0]
_C.SIMULATOR.RGB_SENSOR_RESIZED.ORIENTATION = [0.0, 0.0, 0.0]  # Euler's angles
# _C.SIMULATOR.RGB_SENSOR_RESIZED.VFOV = 90

_C.SIMULATOR.DEPTH_SENSOR_RESIZED = CAMERA_SIM_SENSOR.clone()
_C.SIMULATOR.DEPTH_SENSOR_RESIZED.merge_from_other_cfg(SIMULATOR_DEPTH_SENSOR)
_C.SIMULATOR.DEPTH_SENSOR_RESIZED.TYPE = "HabitatSimDepthSensor"
_C.SIMULATOR.DEPTH_SENSOR_RESIZED.UUID = "depth_resized"
_C.SIMULATOR.DEPTH_SENSOR_RESIZED.HEIGHT = 640
_C.SIMULATOR.DEPTH_SENSOR_RESIZED.WIDTH = 480
_C.SIMULATOR.DEPTH_SENSOR_RESIZED.HFOV = 79
_C.SIMULATOR.DEPTH_SENSOR_RESIZED.POSITION = [0.0, 1.0, 0.0]
_C.SIMULATOR.DEPTH_SENSOR_RESIZED.ORIENTATION = [0.0, 0.0, 0.0]  # Euler's angles
_C.SIMULATOR.DEPTH_SENSOR_RESIZED.MIN_DEPTH = 0.0
_C.SIMULATOR.DEPTH_SENSOR_RESIZED.MAX_DEPTH = 20.0
_C.SIMULATOR.DEPTH_SENSOR_RESIZED.NORMALIZE_DEPTH = False
# _C.SIMULATOR.DEPTH_SENSOR_RESIZED.VFOV = 90

_C.SIMULATOR.SEMANTIC_SENSOR_RESIZED = CAMERA_SIM_SENSOR.clone()
_C.SIMULATOR.SEMANTIC_SENSOR_RESIZED.TYPE = "HabitatSimSemanticSensor"
_C.SIMULATOR.SEMANTIC_SENSOR_RESIZED.UUID = "semantic_resized"
_C.SIMULATOR.SEMANTIC_SENSOR_RESIZED.HEIGHT = 640
_C.SIMULATOR.SEMANTIC_SENSOR_RESIZED.WIDTH = 480
_C.SIMULATOR.SEMANTIC_SENSOR_RESIZED.HFOV = 79
# _C.SIMULATOR.SEMANTIC_SENSOR_RESIZED.VFOV = 90

_C.SIMULATOR.EQUIRECT_RGB_SENSOR_RESIZED = SIMULATOR_SENSOR.clone()
_C.SIMULATOR.EQUIRECT_RGB_SENSOR_RESIZED.TYPE = "HabitatSimEquirectangularRGBSensor"
_C.SIMULATOR.EQUIRECT_RGB_SENSOR_RESIZED.UUID = "rgb_equirectangular"
_C.SIMULATOR.EQUIRECT_RGB_SENSOR_RESIZED.HEIGHT = 400
_C.SIMULATOR.EQUIRECT_RGB_SENSOR_RESIZED.WIDTH = 1600
_C.SIMULATOR.EQUIRECT_RGB_SENSOR_RESIZED.HFOV = 90
_C.SIMULATOR.EQUIRECT_RGB_SENSOR_RESIZED.VFOV = 360

_C.SIMULATOR.EQUIRECT_SEMANTIC_SENSOR_RESIZED = SIMULATOR_SENSOR.clone()
_C.SIMULATOR.EQUIRECT_SEMANTIC_SENSOR_RESIZED.TYPE = "HabitatSimEquirectangularSemanticSensor"
_C.SIMULATOR.EQUIRECT_SEMANTIC_SENSOR_RESIZED.UUID = "semantic_equirectangular"
_C.SIMULATOR.EQUIRECT_SEMANTIC_SENSOR_RESIZED.HEIGHT = 400
_C.SIMULATOR.EQUIRECT_SEMANTIC_SENSOR_RESIZED.WIDTH = 1600
_C.SIMULATOR.EQUIRECT_SEMANTIC_SENSOR_RESIZED.HFOV = 90
_C.SIMULATOR.EQUIRECT_SEMANTIC_SENSOR_RESIZED.VFOV = 360

_C.SIMULATOR.EQUIRECT_DEPTH_SENSOR_RESIZED = SIMULATOR_SENSOR.clone()
_C.SIMULATOR.EQUIRECT_DEPTH_SENSOR_RESIZED.merge_from_other_cfg(SIMULATOR_DEPTH_SENSOR)
_C.SIMULATOR.EQUIRECT_DEPTH_SENSOR_RESIZED.TYPE = "HabitatSimEquirectangularDepthSensor"
_C.SIMULATOR.EQUIRECT_DEPTH_SENSOR_RESIZED.UUID = "depth_equirectangular"
_C.SIMULATOR.EQUIRECT_DEPTH_SENSOR_RESIZED.HEIGHT = 400
_C.SIMULATOR.EQUIRECT_DEPTH_SENSOR_RESIZED.WIDTH = 1600
_C.SIMULATOR.EQUIRECT_DEPTH_SENSOR_RESIZED.HFOV = 90
_C.SIMULATOR.EQUIRECT_DEPTH_SENSOR_RESIZED.VFOV = 360
_C.SIMULATOR.EQUIRECT_DEPTH_SENSOR_RESIZED.NORMALIZE_DEPTH = False
